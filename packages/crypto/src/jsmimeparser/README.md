...
```js
import { parseMail } from './jsmimeparser';
...
See `test/test_mail_parser.spec.ts` for other examples with different MIME messages. Type information can be found in `index.d.ts`.
