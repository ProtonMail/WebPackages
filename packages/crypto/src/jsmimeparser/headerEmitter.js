...
import { kMonthNames } from "./utils.js";
import { uint8ArrayToBinaryString } from "./utils.js";
...
*/
  ...
  *                                breakpoint.
  */
    addPhrase(text, qchars, mayBreakAfter) {
...
const b64Prelude = "=?UTF-8?B?";
const qpPrelude = "=?UTF-8?Q?";
...
*/
export function makeStreamingEmitter(handler, options) {
