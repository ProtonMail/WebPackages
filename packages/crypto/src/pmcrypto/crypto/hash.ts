 ...
 */
export const unsafeMD5 = async (data: Uint8Array<ArrayBuffer>) =>
    import("@noble/hashes/legacy.js").then(
        ({ md5 }) => md5(data) as Uint8Array<ArrayBuffer>,
    );
 ...
 */
export async function unsafeSHA1(
