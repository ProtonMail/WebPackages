...
export function generateSessionKeyForAlgorithm(
    algoName: "aes128" | "aes192" | "aes256",
): Promise<Uint8Array<ArrayBuffer>>;
type GenerateSessionKeyOptions = Parameters<
    typeof openpgp_generateSessionKey
>[0];
export interface GenerateSessionKeyOptionsPmcrypto extends Omit<
...
export function generateSessionKey(
    options: GenerateSessionKeyOptionsPmcrypto,
): Promise<SessionKey>;
