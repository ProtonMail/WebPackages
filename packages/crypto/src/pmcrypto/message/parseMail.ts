 ...
 */
export const parseMail = (mail: string | Uint8Array<ArrayBuffer>) =>
    import("../../jsmimeparser/index.js").then(({ parseMail: jsmimeParseEmail }) =>
        jsmimeParseEmail(mail),
    );
...
export const generateFileName = (
    ...
    const defaultExt =
        !parsedFileName && contentType ? mimeExtensions[contentType] : "";
    const fileName =
        parsedFileName ||
        (defaultExt ? `attachment.${defaultExt}` : "attachment");
