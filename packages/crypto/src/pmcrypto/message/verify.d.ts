...
export interface VerifyMessageResult<
    DataType extends openpgp_VerifyMessageResult["data"] = Data,
> {
    data: DataType;
...
export function verifyMessage<
    ...
    FormatType extends VerifyOptions["format"] = "utf8",
>(
...
export interface VerifyCleartextOptionsPmcrypto extends Omit<
    VerifyOptions,
