...
export interface WorkerDecryptionOptions extends Omit<
...
export interface WorkerVerifyOptions<T extends Data> extends Omit<
    VerifyOptionsPmcrypto<T>,
    "signature" | "verificationKeys"
> {
    armoredSignature?: string;
    binarySignature?: Uint8Array<ArrayBuffer>;
    verificationKeys: MaybeArray<PublicKeyReference>;
...
export interface WorkerVerifyCleartextOptions extends Omit<
    VerifyCleartextOptionsPmcrypto,
    "cleartextMessage" | "verificationKeys"
> {
    armoredCleartextMessage: string;
    verificationKeys: MaybeArray<PublicKeyReference>;
    config?: PartialConfig;
}
export interface WorkerVerificationResult<T extends Data = Data> extends Omit<
    VerifyMessageResult<T>,
    "signatures"
> {
    signatures: Uint8Array<ArrayBuffer>[];
}

export interface WorkerSignOptions<T extends Data> extends Omit<
    SignOptionsPmcrypto<T>,
    "signingKeys"
> {
    format?: "armored" | "binary";
    signingKeys?: MaybeArray<PrivateKeyReference>;
}
export interface WorkerEncryptOptions<T extends Data> extends Omit<
    EncryptOptionsPmcrypto<T>,
    "signature" | "signingKeys" | "encryptionKeys"
> {
    format?: "armored" | "binary";
    armoredSignature?: string;
    binarySignature?: Uint8Array<ArrayBuffer>;
...
export interface WorkerProcessMIMEResult extends Omit<
    ProcessMIMEResult,
    "signatures"
> {
    signatures: Uint8Array<ArrayBuffer>[];
...
export type WorkerExportedKey<
    F extends "armored" | "binary" | undefined = "armored",
> = F extends "armored" ? string : Uint8Array<ArrayBuffer>;
...
export interface WorkerReformatKeyOptions extends Omit<
    ReformatKeyOptions,
    "privateKey" | "format" | "passphrase"
> {
    privateKey: PrivateKeyReference;
}

export interface WorkerEncryptSessionKeyOptions extends Omit<
    EncryptSessionKeyOptionsPmcrypto,
    "encryptionKeys"
> {
...
export interface WorkerGenerateSessionKeyOptions extends Omit<
    GenerateSessionKeyOptionsPmcrypto,
    "recipientKeys"
> {
...
export interface WorkerDecryptSessionKeyOptions extends Omit<
    DecryptSessionKeyOptionsPmcrypto,
