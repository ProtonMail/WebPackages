 ...
 */
export const generateKey = (): Uint8Array<ArrayBuffer> =>
 ...
 *
 */
export const generateAndImportKey = (
...
export const deriveKey = async (
    ...
    if (highEntropySecret.length < 16) {
        throw new Error(
            "Unexpected HKDF input size: secret input is too short",
        );
    }
...
export const unwrapKey = async (
    ...
    wrappingKey: WrappingCryptoKey,
    {
        keyUsage: unwrappedKeyUsage = ["decrypt", "encrypt"],
        extractable = false,
    }: AesGcmKeyOptions = {},
): Promise<AesGcmCryptoKey> => {
