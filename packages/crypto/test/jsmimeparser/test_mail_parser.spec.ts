...
import { read_file_raw } from "./utils.js";
import { parseMail } from "../../src/jsmimeparser/index.js";
...
describe("mail parser", () => {
    it("correctly parses multipart message with both HTML and plain text data", async () => {
        ...
        expect(attachments[0].content.toBase64()).to.equal("VGhpcyBpc24ndCByZWFsbHkgYW4gYXBwbGljYXRpb24vb2N0ZXQtc3RyZWFtLiA7KQ==");
        ...
        expect(attachments[1].content.toBase64()).to.equal("TmVpdGhlciBpcyB0aGlzIGFuIGltYWdlL3BuZy4=");
...
--------------cJMvmFk1NneB7MT4jwYHY7ap--`;
    ...
    it("correctly parses SHIFT-JIS body with png attachment", async () => {
        ...
        expect(attachment.content.toBase64()).to.equal(expectedAttachmentContent);
